...
por marcos pequenos e verificaveis. O marco atual entrega uma imagem bootavel
com console visual, inicializacao de subsistemas e stubs para servidores.

## Milestone 0: base bootavel
...
| --- | --- |
| `boot/boot.asm` | Setor de boot BIOS, leitura do kernel do disco e salto para `0x1000`. |
| `kernel/kernel.asm` | Entrada do kernel, pilha, segmentos, serial, VGA e orquestracao dos subsistemas. |
